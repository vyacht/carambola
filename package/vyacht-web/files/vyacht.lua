...
function changeEthernet(params)
	...
	if realDev == "eth0.2" and not devices.eth02.installed then
        	vWrite("{\"error\": \"Ethernet 2 is not installed!\"}")
        	return
	end

	if realDev == "eth0.1" and not devices.eth01.installed then
	...
	-- preventing lock-out	
	if lanwan == "wan" and realDev == "eth0.2" and devices.eth01.installed == 0 then 
...
function changeWifi(params) 
	...
	vWrite("HTTP/1.0 200 OK\r\n")
		...
		if devices.eth01.available == 0 and devices.eth02.type == "wan" then
